 ...
 * <li>Initialize BuiltTwitterLoginActivity in manifest refer <a href="http://docs.built.io/quickstart/index.html#android">Quick Start Documentation.</a></li><br>
 * <pre class="prettyprint">
...
public abstract class BuiltUILoginController extends FragmentActivity{
	...
	/**
	 * Provides TextView object which will be used for login button information.
	 */
	public TextView loginInfoTextView;
	
	/**
	 * Provides TextView object which will be used for sign up button information.
	 */
	public TextView signUpInfoTextView;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		loginInfoTextView			 =  (TextView) findViewById(R.id.googleInfo);
		signUpInfoTextView			 =  (TextView) findViewById(R.id.signUpInfo);
