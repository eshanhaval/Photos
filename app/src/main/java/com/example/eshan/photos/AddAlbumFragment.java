 ...
 * {@link AddAlbumFragment.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link AddAlbumFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class AddAlbumFragment extends Fragment implements View.OnClickListener{
    ...
    private EditText albumDescEditView;
    private EditText albumNameEditView;
...
//    private OnFragmentInteractionListener mListener;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        addAlbum = (Button)rootView.findViewById(R.id.addalbum);
    ...
    public void onClick(View v) {
        if(v.getId() == R.id.addalbum){
            String album_name = albumNameEditView.getText().toString();
            String album_desc = albumDescEditView.getText().toString();

            Log.i("name",album_name);
...
//
//            projectObject.set("name", album_name);
//            projectObject.set("description", album_desc);
//            projectObject.set("email", HomeActivity.useremail );
//
//            projectObject.saveInBackground(new BuiltResultCallBack() {
//
//                @Override
//                public void onCompletion(BuiltError.ResponseType responseType, BuiltError error) {
//
//                    if(error == null){
